...
declare const DescribeSlotCommand_base: {
    new (input: DescribeSlotCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSlotCommandInput, DescribeSlotCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeSlotCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSlotCommandInput, DescribeSlotCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
