...
declare const GetTestExecutionArtifactsUrlCommand_base: {
    new (input: GetTestExecutionArtifactsUrlCommandInput): import("@smithy/smithy-client").CommandImpl<GetTestExecutionArtifactsUrlCommandInput, GetTestExecutionArtifactsUrlCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetTestExecutionArtifactsUrlCommandInput): import("@smithy/smithy-client").CommandImpl<GetTestExecutionArtifactsUrlCommandInput, GetTestExecutionArtifactsUrlCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
