...
declare const DescribeSlotTypeCommand_base: {
    new (input: DescribeSlotTypeCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSlotTypeCommandInput, DescribeSlotTypeCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeSlotTypeCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSlotTypeCommandInput, DescribeSlotTypeCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
