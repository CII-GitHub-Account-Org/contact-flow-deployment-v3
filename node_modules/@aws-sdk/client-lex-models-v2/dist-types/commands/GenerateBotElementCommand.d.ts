...
declare const GenerateBotElementCommand_base: {
    new (input: GenerateBotElementCommandInput): import("@smithy/smithy-client").CommandImpl<GenerateBotElementCommandInput, GenerateBotElementCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GenerateBotElementCommandInput): import("@smithy/smithy-client").CommandImpl<GenerateBotElementCommandInput, GenerateBotElementCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
