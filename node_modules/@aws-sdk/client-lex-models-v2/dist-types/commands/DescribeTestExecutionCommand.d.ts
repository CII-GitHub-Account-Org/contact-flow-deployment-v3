...
declare const DescribeTestExecutionCommand_base: {
    new (input: DescribeTestExecutionCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTestExecutionCommandInput, DescribeTestExecutionCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeTestExecutionCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTestExecutionCommandInput, DescribeTestExecutionCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
