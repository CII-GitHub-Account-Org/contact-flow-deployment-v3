...
declare const DescribeTestSetDiscrepancyReportCommand_base: {
    new (input: DescribeTestSetDiscrepancyReportCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTestSetDiscrepancyReportCommandInput, DescribeTestSetDiscrepancyReportCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeTestSetDiscrepancyReportCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTestSetDiscrepancyReportCommandInput, DescribeTestSetDiscrepancyReportCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
