...
declare const DescribeTestSetGenerationCommand_base: {
    new (input: DescribeTestSetGenerationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTestSetGenerationCommandInput, DescribeTestSetGenerationCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeTestSetGenerationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTestSetGenerationCommandInput, DescribeTestSetGenerationCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
