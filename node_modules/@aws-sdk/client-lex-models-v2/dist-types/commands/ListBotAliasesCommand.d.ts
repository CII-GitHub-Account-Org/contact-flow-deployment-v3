...
declare const ListBotAliasesCommand_base: {
    new (input: ListBotAliasesCommandInput): import("@smithy/smithy-client").CommandImpl<ListBotAliasesCommandInput, ListBotAliasesCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListBotAliasesCommandInput): import("@smithy/smithy-client").CommandImpl<ListBotAliasesCommandInput, ListBotAliasesCommandOutput, LexModelsV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
