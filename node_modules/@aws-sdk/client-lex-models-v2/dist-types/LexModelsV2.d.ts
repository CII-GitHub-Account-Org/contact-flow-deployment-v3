...
export interface LexModelsV2 {
     ...
     */
    createBotReplica(args: CreateBotReplicaCommandInput, options?: __HttpHandlerOptions): Promise<CreateBotReplicaCommandOutput>;
    createBotReplica(args: CreateBotReplicaCommandInput, cb: (err: any, data?: CreateBotReplicaCommandOutput) => void): void;
    createBotReplica(args: CreateBotReplicaCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateBotReplicaCommandOutput) => void): void;
    /**
     ...
     */
    deleteBotReplica(args: DeleteBotReplicaCommandInput, options?: __HttpHandlerOptions): Promise<DeleteBotReplicaCommandOutput>;
    deleteBotReplica(args: DeleteBotReplicaCommandInput, cb: (err: any, data?: DeleteBotReplicaCommandOutput) => void): void;
    deleteBotReplica(args: DeleteBotReplicaCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteBotReplicaCommandOutput) => void): void;
    /**
     ...
     */
    describeBotReplica(args: DescribeBotReplicaCommandInput, options?: __HttpHandlerOptions): Promise<DescribeBotReplicaCommandOutput>;
    describeBotReplica(args: DescribeBotReplicaCommandInput, cb: (err: any, data?: DescribeBotReplicaCommandOutput) => void): void;
    describeBotReplica(args: DescribeBotReplicaCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeBotReplicaCommandOutput) => void): void;
    /**
     * @see {@link DescribeBotResourceGenerationCommand}
     */
    describeBotResourceGeneration(args: DescribeBotResourceGenerationCommandInput, options?: __HttpHandlerOptions): Promise<DescribeBotResourceGenerationCommandOutput>;
    describeBotResourceGeneration(args: DescribeBotResourceGenerationCommandInput, cb: (err: any, data?: DescribeBotResourceGenerationCommandOutput) => void): void;
    describeBotResourceGeneration(args: DescribeBotResourceGenerationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeBotResourceGenerationCommandOutput) => void): void;
    /**
     ...
     */
    generateBotElement(args: GenerateBotElementCommandInput, options?: __HttpHandlerOptions): Promise<GenerateBotElementCommandOutput>;
    generateBotElement(args: GenerateBotElementCommandInput, cb: (err: any, data?: GenerateBotElementCommandOutput) => void): void;
    generateBotElement(args: GenerateBotElementCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GenerateBotElementCommandOutput) => void): void;
    /**
     ...
     */
    listBotReplicas(args: ListBotReplicasCommandInput, options?: __HttpHandlerOptions): Promise<ListBotReplicasCommandOutput>;
    listBotReplicas(args: ListBotReplicasCommandInput, cb: (err: any, data?: ListBotReplicasCommandOutput) => void): void;
    listBotReplicas(args: ListBotReplicasCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListBotReplicasCommandOutput) => void): void;
    /**
     * @see {@link ListBotResourceGenerationsCommand}
     */
    listBotResourceGenerations(args: ListBotResourceGenerationsCommandInput, options?: __HttpHandlerOptions): Promise<ListBotResourceGenerationsCommandOutput>;
    listBotResourceGenerations(args: ListBotResourceGenerationsCommandInput, cb: (err: any, data?: ListBotResourceGenerationsCommandOutput) => void): void;
    listBotResourceGenerations(args: ListBotResourceGenerationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListBotResourceGenerationsCommandOutput) => void): void;
    /**
     ...
     */
    listBotVersionReplicas(args: ListBotVersionReplicasCommandInput, options?: __HttpHandlerOptions): Promise<ListBotVersionReplicasCommandOutput>;
    listBotVersionReplicas(args: ListBotVersionReplicasCommandInput, cb: (err: any, data?: ListBotVersionReplicasCommandOutput) => void): void;
    listBotVersionReplicas(args: ListBotVersionReplicasCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListBotVersionReplicasCommandOutput) => void): void;
    /**
     ...
     */
    listIntentMetrics(args: ListIntentMetricsCommandInput, options?: __HttpHandlerOptions): Promise<ListIntentMetricsCommandOutput>;
    listIntentMetrics(args: ListIntentMetricsCommandInput, cb: (err: any, data?: ListIntentMetricsCommandOutput) => void): void;
    listIntentMetrics(args: ListIntentMetricsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListIntentMetricsCommandOutput) => void): void;
    /**
     * @see {@link ListIntentPathsCommand}
     */
    listIntentPaths(args: ListIntentPathsCommandInput, options?: __HttpHandlerOptions): Promise<ListIntentPathsCommandOutput>;
    listIntentPaths(args: ListIntentPathsCommandInput, cb: (err: any, data?: ListIntentPathsCommandOutput) => void): void;
    listIntentPaths(args: ListIntentPathsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListIntentPathsCommandOutput) => void): void;
    /**
     ...
     */
    listIntentStageMetrics(args: ListIntentStageMetricsCommandInput, options?: __HttpHandlerOptions): Promise<ListIntentStageMetricsCommandOutput>;
    listIntentStageMetrics(args: ListIntentStageMetricsCommandInput, cb: (err: any, data?: ListIntentStageMetricsCommandOutput) => void): void;
    listIntentStageMetrics(args: ListIntentStageMetricsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListIntentStageMetricsCommandOutput) => void): void;
    /**
     ...
     */
    listSessionAnalyticsData(args: ListSessionAnalyticsDataCommandInput, options?: __HttpHandlerOptions): Promise<ListSessionAnalyticsDataCommandOutput>;
    listSessionAnalyticsData(args: ListSessionAnalyticsDataCommandInput, cb: (err: any, data?: ListSessionAnalyticsDataCommandOutput) => void): void;
    listSessionAnalyticsData(args: ListSessionAnalyticsDataCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListSessionAnalyticsDataCommandOutput) => void): void;
    /**
     * @see {@link ListSessionMetricsCommand}
     */
    listSessionMetrics(args: ListSessionMetricsCommandInput, options?: __HttpHandlerOptions): Promise<ListSessionMetricsCommandOutput>;
    listSessionMetrics(args: ListSessionMetricsCommandInput, cb: (err: any, data?: ListSessionMetricsCommandOutput) => void): void;
    listSessionMetrics(args: ListSessionMetricsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListSessionMetricsCommandOutput) => void): void;
    /**
     ...
     */
    listUtteranceAnalyticsData(args: ListUtteranceAnalyticsDataCommandInput, options?: __HttpHandlerOptions): Promise<ListUtteranceAnalyticsDataCommandOutput>;
    listUtteranceAnalyticsData(args: ListUtteranceAnalyticsDataCommandInput, cb: (err: any, data?: ListUtteranceAnalyticsDataCommandOutput) => void): void;
    listUtteranceAnalyticsData(args: ListUtteranceAnalyticsDataCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListUtteranceAnalyticsDataCommandOutput) => void): void;
    /**
     * @see {@link ListUtteranceMetricsCommand}
     */
    listUtteranceMetrics(args: ListUtteranceMetricsCommandInput, options?: __HttpHandlerOptions): Promise<ListUtteranceMetricsCommandOutput>;
    listUtteranceMetrics(args: ListUtteranceMetricsCommandInput, cb: (err: any, data?: ListUtteranceMetricsCommandOutput) => void): void;
    listUtteranceMetrics(args: ListUtteranceMetricsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListUtteranceMetricsCommandOutput) => void): void;
    /**
     ...
     */
    startBotResourceGeneration(args: StartBotResourceGenerationCommandInput, options?: __HttpHandlerOptions): Promise<StartBotResourceGenerationCommandOutput>;
    startBotResourceGeneration(args: StartBotResourceGenerationCommandInput, cb: (err: any, data?: StartBotResourceGenerationCommandOutput) => void): void;
    startBotResourceGeneration(args: StartBotResourceGenerationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartBotResourceGenerationCommandOutput) => void): void;
    /**
